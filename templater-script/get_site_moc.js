...
class MOCBuilder {
    constructor(options = {}) {
        ...
        this.parser = new WikiParser({ defaultImageWidth: this.options.defaultImageWidth });
        this.fm = new FrontmatterHelper();
...
const mocBuilder = new MOCBuilder();

module.exports = mocBuilder.build.bind(mocBuilder);
